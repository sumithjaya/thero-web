      ...
      <div className={styles.testimonialRow}>
        <div className={styles.testimonialLeft}>
          ...
          <h4 className={styles.testimonialTitle}>
            What they say, from our <span className={styles.primary}>clients</span>
          </h4>
          <p className={styles.testimonialSubcopy}>Our customers says about serving quality and other.</p>
        ...
        <div className={styles.testimonialCardsCol}>
          ...
          <div key={fadeKey} className={styles.slidesWrap}>
            {slides.map((t) => (
              <div key={t.id} className={`${styles.testimonialCard} ${styles.testimonialCardOffset}`}>
                <div>
                  <div className={styles.avatarPad}>
                    <div className="relative" style={{ height: "80px", width: "80px" }}>
                      <Image src={t.photo} alt={`${t.name} photo`} fill className="rounded-full object-cover object-center" />
                    </div>
                  </div>
                </div>
                <div className={styles.testimonialContentPad}>
                  ...
                  <div className={styles.userRow}>
                    <svg width="24px" height="64px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                      <path d="M2 8a1 1 0 011-1h10a1 1 0 110 2H3a1 1 0 01-1-1z" fill="#bdbfc0ff"></path>
                    </svg>
          ...
          <div className={styles.cardsBacker}>
            <svg width="532" height="540" viewBox="0 0 532 540" fill="none" xmlns="http://www.w3.org/2000/svg">
